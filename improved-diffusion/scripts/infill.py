...
sys.path.insert(0, '/home/exouser/Capstone/Diffusion-LM-main/transformers/examples/pytorch/language-modeling')
    ...
    if args.modality in ['synth', 'pos']:
        ...
        if args.eval_task_ == 'infill':
            ...
            if args.eval_task_ == 'control_attribute':
                ...
                control_label_lst = []
                with open('/home/exouser/Capstone/Diffusion-LM-main/improved-diffusion/control_gen/target_attribute.json', 'r') as controlf:
            ...
            if args.eval_task_ == 'control_attribute_compose':
                ...
                model_control = Classifier_POS.from_pretrained(args.classifier_path).cuda()
                ...
                ################33
                control_label_lst = []
                with open('/home/exouser/Capstone/Diffusion-LM-main/improved-diffusion/control_gen/target_pos.json', 'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
                print(control_label_lst[:5])
                control_constraints = []
                ...
                model_control = Classifier_Tree.from_pretrained(args.classifier_path).cuda()
                # print(model_control)
                ...
                ###############
                control_label_lst = []
                #with open('/home/exouser/Capstone/Diffusion-LM-main/improved-diffusion/control_gen/target_tree.json',
                with open('/home/exouser/Capstone/Diffusion-LM-main/datasets/control_target/target_tree.json',
                          'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
                ...
                ###############
                control_label_lst = []
                with open('/home/exouser/Capstone/Diffusion-LM-main/improved-diffusion/control_gen/target_spans.json',
                          'r') as controlf:
                    for line in controlf:
                        control_label_lst.append(json.loads(line))
                # print(control_label_lst[:1])
...
def create_argparser():
    defaults = dict(
        ...
        out_dir="/home/exouser/Capstone/Diffusion-LM-main/improved-diffusion/out_gen",
        ...
        start_idx=0, end_idx=0,classifier_path='',
    )
